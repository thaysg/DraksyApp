...
class BottomBarItem {
  ...
  /// * [selectedIcon] is an optional widget to display when the item
  /// * is selected.
  /// * [backgroundColor] sets the item's background color.
  /// * [unSelectedColor] sets the color of the icon and text when the item is
  /// * not selected. Defaults to [Colors.grey].
  /// * [selectedColor] sets the color of the icon and text when the item is
  /// * selected. Defaults to [Colors.green].
  /// * [badge] is an optional widget to display as a badge.
  /// * [badgeColor] sets the badge's background color. Defaults to
  /// * [Colors.grey].
  /// * [showBadge] determines whether to show the badge. Defaults to `false`.
  /// * [badgePadding] sets the padding around the badge.
  /// * [borderColor] sets the color of the border around the item. Defaults
  /// * to [AppColors.surfaceDark].
  BottomBarItem({
    required this.icon,
    required this.title,
    this.selectedIcon,
    ...
    this.badgePadding,
    this.borderColor = AppColors.surfaceDark,
  });
  ...
  ///
  /// Defaults to [AppColors.surfaceDark].
  final Color borderColor;

  ///The `backgroundColor` property is used to assign a [backgroundColor]
  /// to [BottomBarItem].
  /// If a value is assigned to this property, the [BottomBarItem] will
  ///  be displayed
