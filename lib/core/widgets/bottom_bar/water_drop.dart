...
class WaterDrop extends StatelessWidget {
      ...
      decoration: color != null
          ? BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  Color.lerp(color, AppColors.surfaceDark, 0.1)!,
                  Color.lerp(color, AppColors.surfaceLight, 0.9)!,
                  color!,
                ],
              ),
            )
      ...
      foregroundDecoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          ...
          colors: [
            ...
            AppColors.surfaceLight.withValues(alpha: 0.1), // Slight white
          ],
        ),
  ...
  Alignment getAlignment(Size screenSize) => Alignment(
